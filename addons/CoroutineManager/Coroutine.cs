...
/// </summary>
internal class WaitForSecondsHelper
{
    internal static WaitForSecondsHelper waiter = new WaitForSecondsHelper();
    internal float waitTime;

    internal WaitForSecondsHelper Wait(float seconds)
    {
